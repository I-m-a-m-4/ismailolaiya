...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticPages: MetadataRoute.Sitemap = [
        ...
        { url: `${URL}/diary/news`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
        { url: `${URL}/diary/underdogs`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
        { url: `${URL}/diary/podcast`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
        { url: `${URL}/diary/resource-library`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
        { url: `${URL}/diary/interviews`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
